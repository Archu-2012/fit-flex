...
const Exercise = () => {
  ...
  const fetchData = async (id) => {
      const options = {
        ...
        headers: {
          'X-RapidAPI-Key': '3f0271c296msh9ec142db31d7003p14da44jsn9b037041b841',
        ...
        {relatedVideos && relatedVideos.length > 0 && (
          ...
          <div className="related-videos">
            {relatedVideos.map((video, index) => { return index < 15 && (
              <div className="related-video" key={index} onClick={()=> window.open(`https://www.youtube.com/watch?v=D-nDfRFji3I${video.video.videoId}`, "_blank")} >
